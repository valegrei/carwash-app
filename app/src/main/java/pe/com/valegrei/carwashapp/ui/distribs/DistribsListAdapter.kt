...
class DistribsListAdapter(private val onItemClicked: (Usuario) -> Unit) :
    ListAdapter<Usuario, DistribsListAdapter.DistribViewHolder>(DiffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DistribViewHolder {
        return DistribViewHolder(ItemDistribsBinding.inflate(LayoutInflater.from(parent.context),parent, false))
    }

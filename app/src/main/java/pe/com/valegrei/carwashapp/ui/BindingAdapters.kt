...
fun bindCheckStatus(textView: TextView, tipoUsuario: Int) {
    when (tipoUsuario) {
        TipoUsuario.ADMIN.id -> textView.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_baseline_setting_purple_24,0,0,0)
        TipoUsuario.CLIENTE.id -> textView.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_baseline_person_purple_24,0,0,0)
        TipoUsuario.DISTR.id -> textView.setCompoundDrawablesRelativeWithIntrinsicBounds(R.drawable.ic_baseline_store_purple_24,0,0,0)
    }
}

...
import pe.com.carwashperuapp.carwashapp.databinding.ItemServiceOfferedBinding
...
class ServiceOfferedListAdapter :
    ListAdapter<ServicioReserva, ServiceOfferedListAdapter.ViewHolder>(DiffCallback) {

    /**
     * Provide a reference to the type of views that you are using
     * (custom ViewHolder).
     */
    class ViewHolder(private val binding: ItemServiceOfferedBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemServiceOfferedBinding.inflate(LayoutInflater.from(parent.context), parent, false)
